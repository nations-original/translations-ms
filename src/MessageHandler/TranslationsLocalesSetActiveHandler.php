...
use App\Message\TranslationsLocalesSetActive;
...
#[AsMessageHandler]
final class TranslationsLocalesSetActiveHandler
{
    ...
    public function __invoke(TranslationsLocalesSetActive $message)
    {
